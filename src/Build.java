...
public class Build {
  ...
  public static void printShortWords(Vertex<String> vertex, int k) {
    ...
    printShortWordsHelper(vertex, k, seen);
  ...
  private static void printShortWordsHelper(Vertex<String> vertex, int k, Set<Vertex<String>> seen) {
    ...
    for (Vertex<String> neighbor: vertex.neighbors) {
      printShortWordsHelper(neighbor, k, seen);
    }
  ...
  private static <T> void unreachableHelper(Map<T, List<T>> graph, T node, Set<T> seen) {
    ...
    for (T neighbor : neighbors) {
      unreachableHelper(graph, neighbor, seen);
    }
  }
}
